public class SubtractionAssignment_FA {
    public static boolean valid_minusEquals(String str) {
        str += "@";
    ...
    public static void main(String[] args) {
        System.out.println(valid_minusEquals("-="));                                   //return true
        System.out.println(valid_minusEquals("--"));                                   //return false
        System.out.println(valid_minusEquals("="));                                   //return false
        System.out.println(valid_minusEquals("-"));                                   //return false
    }
}
