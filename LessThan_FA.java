public class LessThan_FA {
    public static boolean valid_lessThan(String str) {
        str += "@";
    ...
    public static void main(String[] args) {
        System.out.println(valid_lessThan("<"));                                   //return true
        System.out.println(valid_lessThan("<<"));                                   //return false
    }
}