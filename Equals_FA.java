public class Equals_FA {
    public static boolean valid_Equals(String str) {
        str += "@";
    ...
    public static void main(String[] args) {
        System.out.println(valid_Equals("="));                                   //return true
        System.out.println(valid_Equals("=="));                                   //return false
    }
}