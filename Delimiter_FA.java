public class Delimiter_FA {
    public static boolean valid_Delimiter(String str) {
        str += "@";
    ...
    public static void main(String[] args) {
        System.out.println(valid_Delimiter(";"));                                   //return true
        System.out.println(valid_Delimiter(";;"));                                   //return false
        System.out.println(valid_Delimiter(":"));                                   //return false
    }
}