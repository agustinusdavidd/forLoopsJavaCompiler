...
pada kode yang di inputkan, khususnya untuk mengenali pola penulisan "for"
*/
public class For_FA {
    public static boolean valid_for(String str) {
        /*
        inputan for yang mungkin :
        for, For, FOr, FOR, fOr, dll

        Karena java case sensitive maka yang diterima hanyalah bentuk "for"
        ...
        String[] kolom = new String[] {"f"  ,"o"   ,"r"   ,"selain for" ,"EOS"};    //Selain for juga termasuk penulisan for dalam huruf kapital
        ...
        while(!state.equalsIgnoreCase("acc")){
            ...
            if(symbol == 'f'){
                ...
                input = "EOS";
            } else if(symbol != 'f' && symbol != 'o' && symbol != 'r') {
                input = "selain for";
            } else {
                return false;
            }
    ...
    public static void main(String[] args) {
        System.out.println(valid_for("forr"));                                  //return false
        System.out.println(valid_for("FOR"));                                   //return false
        System.out.println(valid_for("for "));                                  //return false
        System.out.println(valid_for("for"));                                   //return true
    }
}
