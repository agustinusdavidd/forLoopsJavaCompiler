public class GreaterThan_FA {
    public static boolean valid_greaterThan(String str) {
        str += "@";
    ...
    public static void main(String[] args) {
        System.out.println(valid_greaterThan(">"));                                   //return true
        System.out.println(valid_greaterThan(">>"));                                   //return false
    }
}